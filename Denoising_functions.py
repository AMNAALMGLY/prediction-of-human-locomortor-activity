...
#            print "risks[222]:", risks[222]
        ...
        th = sqrt(2*log(len(x)))        
        if n == 0:
            th = 0.239171507917073
        elif n == 1:
            th = 0.213175178156045
        elif n == 2:
            th =  0.131215609693649
        elif n == 3:
            th = 0.075045781299635
...
def waveletSmooth( x, wavelet, level=1):
